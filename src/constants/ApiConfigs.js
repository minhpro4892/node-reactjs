...
export const createNotificationApi = serverBase + '/api/notification/create';
export const getAllNotificationApi = serverBase + '/api/notification/getAll';
export const deleteNotificationApi = serverBase + '/api/notification/delete';
export const viewNotificationApi = serverBase + '/api/notification/view';
export const updateNotificationApi = serverBase + '/api/notification/update';
